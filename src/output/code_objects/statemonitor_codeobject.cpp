...
const size_t _num_indices = 0;
    ...
    _dynamic_array_statemonitor_wE.resize(_new_size, _num_indices);
    _dynamic_array_statemonitor_wI_1.resize(_new_size, _num_indices);
    _dynamic_array_statemonitor_wI_2.resize(_new_size, _num_indices);
    _dynamic_array_statemonitor_wI_3.resize(_new_size, _num_indices);
    ...
    for (int _i = 0; _i < (int)_num_indices; _i++)
    {
        ...
        const double _source_wE = _ptr_array_neurongroup_wE[_idx];
        const double _source_v = _ptr_array_neurongroup_v[_idx];
        const double _source_wI_3 = _ptr_array_neurongroup_wI_3[_idx];
        const double _source_wI_1 = _ptr_array_neurongroup_wI_1[_idx];
        const double _source_wI_2 = _ptr_array_neurongroup_wI_2[_idx];
        ...
        _dynamic_array_statemonitor_wE(_new_size-1, _i) = _to_record_wE;
        _dynamic_array_statemonitor_wI_1(_new_size-1, _i) = _to_record_wI_1;
        _dynamic_array_statemonitor_wI_2(_new_size-1, _i) = _to_record_wI_2;
        _dynamic_array_statemonitor_wI_3(_new_size-1, _i) = _to_record_wI_3;
    }
