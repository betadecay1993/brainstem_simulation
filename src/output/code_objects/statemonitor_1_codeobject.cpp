...
const size_t _num_indices = 0;
    ...
    double* __restrict  _ptr_array_neurongroup_1_wE = _array_neurongroup_1_wE;
    ...
    double* __restrict  _ptr_array_neurongroup_1_wI_2 = _array_neurongroup_1_wI_2;
    double* __restrict  _ptr_array_neurongroup_1_v = _array_neurongroup_1_v;
    double* __restrict  _ptr_array_neurongroup_1_wI_3 = _array_neurongroup_1_wI_3;
    double* __restrict  _ptr_array_neurongroup_1_wI_1 = _array_neurongroup_1_wI_1;
    ...
    _dynamic_array_statemonitor_1_wE.resize(_new_size, _num_indices);
    _dynamic_array_statemonitor_1_wI_1.resize(_new_size, _num_indices);
    _dynamic_array_statemonitor_1_wI_2.resize(_new_size, _num_indices);
    _dynamic_array_statemonitor_1_wI_3.resize(_new_size, _num_indices);
    ...
    for (int _i = 0; _i < (int)_num_indices; _i++)
    {
        ...
        const double _source_wE = _ptr_array_neurongroup_1_wE[_idx];
        const double _source_v = _ptr_array_neurongroup_1_v[_idx];
        const double _source_wI_3 = _ptr_array_neurongroup_1_wI_3[_idx];
        const double _source_wI_1 = _ptr_array_neurongroup_1_wI_1[_idx];
        const double _source_wI_2 = _ptr_array_neurongroup_1_wI_2[_idx];
        ...
        _dynamic_array_statemonitor_1_wE(_new_size-1, _i) = _to_record_wE;
        _dynamic_array_statemonitor_1_wI_1(_new_size-1, _i) = _to_record_wI_1;
        _dynamic_array_statemonitor_1_wI_2(_new_size-1, _i) = _to_record_wI_2;
        _dynamic_array_statemonitor_1_wI_3(_new_size-1, _i) = _to_record_wI_3;
    }
