...
const size_t _numlastspike = 100;
    ...
    for(size_t _idx=0; _idx<100; _idx++)
    {
        ...
        const char not_refractory = _ptr_array_neurongroup_4_not_refractory[_idx];
        char _cond;
        if(!not_refractory)
        ...
        if(_cond) {
            ...
            _ptr_array_neurongroup_4_not_refractory[_idx] = false;
            _ptr_array_neurongroup_4_lastspike[_idx] = _ptr_array_defaultclock_t[0];
        }
    }
    _ptr_array_neurongroup_4__spikespace[100] = _count;
