...
const size_t _numu = 100;
    ...
    double* __restrict  _ptr_array_neurongroup_1_d = _array_neurongroup_1_d;
	...
	const int32_t _num_events = _ptr_array_neurongroup_1__spikespace[100];
 ...
 const double _lio_1 = (- 55.0) * 0.001;
	...
	for(int32_t _index_events=0; _index_events<_num_events; _index_events++)
	{
        ...
        const double d = _ptr_array_neurongroup_1_d[_idx];
