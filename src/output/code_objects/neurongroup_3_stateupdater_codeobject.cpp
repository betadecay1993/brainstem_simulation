...
const size_t _numu = 100;
    ...
    double* __restrict  _ptr_array_neurongroup_3_wE2 = _array_neurongroup_3_wE2;
    ...
    double* __restrict  _ptr_array_neurongroup_3_y = _array_neurongroup_3_y;
    ...
    double* __restrict  _ptr_array_neurongroup_3_u = _array_neurongroup_3_u;
    ...
    for(int _idx=0; _idx<_N; _idx++)
    {
        ...
        double wI_3 = _ptr_array_neurongroup_3_wI_3[_idx];
        double wE2 = _ptr_array_neurongroup_3_wE2[_idx];
        double wI_1 = _ptr_array_neurongroup_3_wI_1[_idx];
        double wE = _ptr_array_neurongroup_3_wE[_idx];
        const double y = _ptr_array_neurongroup_3_y[_idx];
        double wI_2 = _ptr_array_neurongroup_3_wI_2[_idx];
        char not_refractory = _ptr_array_neurongroup_3_not_refractory[_idx];
        double u = _ptr_array_neurongroup_3_u[_idx];
        if(!not_refractory)
        ...
        _ptr_array_neurongroup_3_wI_3[_idx] = wI_3;
        _ptr_array_neurongroup_3_wE2[_idx] = wE2;
        _ptr_array_neurongroup_3_wI_1[_idx] = wI_1;
        _ptr_array_neurongroup_3_wE[_idx] = wE;
        _ptr_array_neurongroup_3_wI_2[_idx] = wI_2;
        _ptr_array_neurongroup_3_not_refractory[_idx] = not_refractory;
        _ptr_array_neurongroup_3_u[_idx] = u;
