...
void _run_synapses_12_synapses_create_generator_codeobject()
{
    ...
    ///// CONSTANTS ///////////
    int32_t* const _array_synapses_12_N_incoming = _dynamic_array_synapses_12_N_incoming.empty()? 0 : &_dynamic_array_synapses_12_N_incoming[0];
const size_t _numN_incoming = _dynamic_array_synapses_12_N_incoming.size();
int32_t* const _array_synapses_12_N_outgoing = _dynamic_array_synapses_12_N_outgoing.empty()? 0 : &_dynamic_array_synapses_12_N_outgoing[0];
const size_t _numN_outgoing = _dynamic_array_synapses_12_N_outgoing.size();
int32_t* const _array_synapses_12__synaptic_pre = _dynamic_array_synapses_12__synaptic_pre.empty()? 0 : &_dynamic_array_synapses_12__synaptic_pre[0];
const size_t _num_synaptic_pre = _dynamic_array_synapses_12__synaptic_pre.size();
const size_t _numN = 1;
int32_t* const _array_synapses_12__synaptic_post = _dynamic_array_synapses_12__synaptic_post.empty()? 0 : &_dynamic_array_synapses_12__synaptic_post[0];
const size_t _num_synaptic_post = _dynamic_array_synapses_12__synaptic_post.size();
    ///// POINTERS ////////////
    ...
    const size_t _N_pre = 100;
    const size_t _N_post = 100;
    _dynamic_array_synapses_12_N_incoming.resize(_N_post + 0);
    _dynamic_array_synapses_12_N_outgoing.resize(_N_pre + 0);
    ...
    for(size_t _i=0; _i<_N_pre; _i++)
    {
        ...
        for(long _k=_uiter_low; _k<_uiter_high; _k++)
        {
            if(_jump_algo) {
